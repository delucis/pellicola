 ...
 * @param  {SketchFunction} sketch Renders to `<canvas>`
 * @param  {Object} opts                                  Options object
 * @param  {number} [opts.fps=defaultFrameRate]           Frames per second
 * @param  {'png'|'jpeg'} [opts.frameFormat=defaultFrameFormat] Frame format, e.g. 'png'
 * @param  {Font[]} [opts.fonts]                          Custom fonts to register
 * @param  {number[]} [opts.dimensions]                   [width, height] in pixels
 * @param  {number} [opts.duration]                       Animation length in seconds
 * @param  {number} [opts.totalFrames]                    Animation length in frames
 * @param  {number} [opts.time=0]                         Start time in seconds
 * @param  {number} [opts.frame=0]                        Initial frame number
 * @param  {number} [opts.endTime]                        Time to stop rendering at
 * @param  {number} [opts.endFrame]                       Last frame number to render
 * @param  {string} [opts.outDir]                         Directory to write video to
 * @param  {string} [opts.filename]                       Output video file name
 * @param  {boolean} [opts.renderInParallel=false]        Render frames in parallel
 * @param  {number} [opts.maxConcurrency=16]              Number of parallel frames
 * @param  {boolean} [opts.silent=false]                  Suppress progress spinners
 * @param  {MotionBlurConfig} [opts.motionBlur]           Configure motion blur
 * @param  {boolean} [opts.cleanup=true]                  Enable/disable cleanup
